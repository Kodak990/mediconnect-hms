...
<head>
    ...
    <title>MediConnect — Register Patient</title>
    <style>
...
<div class="layout">
    ...
    <main class="main">
        ...
        <div class="page-header">
            ...
            <p>Fill in the patient's details to create their medical record.</p>
        </div>
            ...
            <form method="POST" action="{{ route('patients.store') }}">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <input type="text" name="first_name" value="{{ old('first_name') }}" placeholder="e.g. Chukwuemeka" required/>
                        @error('first_name')<span class="field-error">{{ $message }}</span>@enderror
                    </div>
                    <div class="form-group">
                        <label>Last Name *</label>
                        <input type="text" name="last_name" value="{{ old('last_name') }}" placeholder="e.g. Okafor" required/>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="state_of_origin" value="{{ old('state_of_origin') }}" placeholder="e.g. Lagos"/>
                    </div>
                    <div class="form-group full">
                        <label>Address</label>
                        <textarea name="address" placeholder="Street address, city…">{{ old('address') }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-grid three">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="allergies" value="{{ old('allergies') }}" placeholder="Penicillin, None…"/>
                    </div>
                </div>
