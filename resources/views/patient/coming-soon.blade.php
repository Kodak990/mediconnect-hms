...
<div class="wrap">
    <div class="card">
        ...
        <h2>Patient Portal Coming Soon</h2>
        <p>
            Hi {{ auth()->user()->name }}, your dedicated patient dashboard is currently being built.
            Soon you'll be able to view your appointments, prescriptions, lab results, and bills right here.
