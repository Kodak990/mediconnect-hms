...
<div class="main">
    ...
    <div class="page-header">
        ...
        <p>Your appointment history at MediConnect.</p>
    </div>

    <div class="notice">
        ℹ️ To book a new appointment, please contact the hospital reception or call us directly.
    </div>
    ...
    <div class="card">
        @if($appointments->count())
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><strong>{{ $appt->formatted_date }}</strong></td>
        ...
        @else
            <div class="empty-state">
                <div class="icon">📅</div>
                <p>You have no appointments on record yet.</p>
            </div>
        @endif
    </div>
